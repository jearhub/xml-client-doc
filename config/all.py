...
extensions = [
    ...
    'config.hotelbooki18n',
    'config.hotelbookbranch'
]
...
project = u'XML Client API'
copyright = u'2014, HotelBook'
...
html_short_title = u'XML Client API'
...
htmlhelp_basename = 'XmlClientAPI'
...
latex_documents = [
  ('pdf-contents', 'XMLClientAPI.tex', u'XML Client API Documentation',
   u'Hotelbook', 'manual'),
]

# The name of an image file (relative to this directory) to place at the top of
# the title page.
latex_logo = '../themes/hotelbook/static/pdf-logo.png'
...
man_pages = [
    ('index', 'xmlclientapi', u'XML Client API Documentation',
     [u'Hotelbook'], 1)
]
...
epub_title = u'XML Client API'
epub_author = u'LightSoft Research'
epub_publisher = u'Hotelbook'
epub_copyright = u'Hotelbook'
...
epub_uid = 'xmlclientapi1393624653'
